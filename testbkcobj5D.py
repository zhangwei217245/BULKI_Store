...
if __name__ == "__main__":
    ...
    arr5 = bkc.array_slicing(
        arr4, [slice(0, 1), slice(0, 1), slice(0, 1), slice(0, 1), slice(0, 10, -2)]
    )
    ...
    result = bkc.get_object_data(
        ...
        sub_obj_regions=[
            (
                "arr6",
                [slice(0, 1), slice(0, 1), slice(0, 1), slice(0, 1), slice(0, 2, -1)],
            ),
            (
                "arr4",
                [slice(0, 1), slice(0, 1), slice(0, 1), slice(0, 1), slice(0, 10, -2)],
            ),
        ],
    )
    print(result)
